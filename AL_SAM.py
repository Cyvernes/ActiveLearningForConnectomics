...
if __name__ == "__main__":
    ...
    if   LEARNER_TYPE == "Active Learning":
        ...
        learner = RandomLearner(sam, STRATEGY_SELECTOR, LEARNING_STRATEGIES, FIRST_SEEDS_SELECTOR, SEED_SELECTION_STRATEGIES, UNCERTAINTY_FUNCTION_TYPE, FILTERING_FUNCTION, FILTERING_AUX_FONCTION, use_previous_logits=USE_PREVIOUS_LOGITS)
    else:
